...
RUN R -e 'BiocManager::install("enrichplot",upgrade="never",version="1.20.3")'
...
RUN Rscript -e 'remotes::install_version("grDevices", upgrade="never",version="4.3.1")'
...
RUN Rscript -e 'remotes::install_version("qgraph",upgrade="never",version="1.9.5")'
