...
```{r}
fig_width <- 15
n_lines <- ceiling(length(MOFA2::views_names(MOFARes))/2)
fig_height <- n_lines*4.5
```
...
```{r MOFA2_heatmap1, fig.width = fig_width, fig.height = fig_height}
ggpubr::as_ggplot(list_arrange[[1]])
```

#### Factor 2

```{r MOFA2_heatmap2, fig.width = fig_width, fig.height = fig_height}
...
```{r MOFA2_heatmap3, fig.width = fig_width, fig.height = fig_height}
