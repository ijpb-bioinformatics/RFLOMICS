...
of the following list of `r RFLOMICS:::omicsDic(dataset.SE)[["variableName"]]`  `r dataset.SE@metadata$CoExpAnal$gene.list.names`. 
`r dataset.SE@metadata[["CoExpAnal"]]$tools` was used to cluster the `r RFLOMICS:::omicsDic(dataset.SE)[["variableName"]]`. 
