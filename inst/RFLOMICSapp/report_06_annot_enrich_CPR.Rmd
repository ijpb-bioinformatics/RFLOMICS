...
* **Annotation of the lists of `r omics.dic[[omictype]][["variableName"]]` by `r ontology` ontology:**

Enrichment of type **Overrepresentation analysis (ORA)** was carried out for each list of `r omics.dic[[omictype]][["variableName"]]` 
thanks to the **clusterProfiler** R-package and its **enrich...** functions (@wu-a2021a).
...
**Results by list(s) of `r omics.dic[[omictype]][["variableName"]]`**
