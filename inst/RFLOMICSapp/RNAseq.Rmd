...
```{r CheckDesign1, fig.show = "hold", out.width = "50%", message=FALSE, warning=FALSE, echo=FALSE}
...
* The choosen filtering strategy is `r dataset.SE@metadata$FilteringOptions$Filter_Strategy` with a count per million of read (CPM)
cut-off of `r dataset.SE@metadata$FilteringOptions$CPM_Cutoff`  
...
```{r QCdesign, echo=FALSE , fig.show="hold", message=FALSE, warning=FALSE,out.width = "80%", eval=FALSE}
...
```{r DiffExprRNA1,echo=FALSE,message=FALSE, out.width = "100%",warning=FALSE,  fig.show = "hold", eval=Diff.eval}
...
```{r summaryRNADE, echo=FALSE, results="asis", eval=Diff.eval}
...
```{r DiffExprRNA2,echo=FALSE, message=FALSE, warning=FALSE,  fig.show = "hold", out.width = "80%", echo=FALSE, eval=Diff.eval}
...
```{r DiffPerContRNA, message=FALSE, warning=FALSE, echo=FALSE, echo=FALSE, message=TRUE, warning=TRUE, eval=Diff.eval}
...
```{r Coexp, message=FALSE, warning=FALSE, echo=FALSE, echo=FALSE, message=TRUE, warning=TRUE, eval=CoEx.eval}
