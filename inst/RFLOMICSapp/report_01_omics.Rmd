...
if(!is.null(dataset.SE)){
  ...
  Diff.ann.eval_CPR <- !is.null(dataset.SE@metadata[["DiffExpEnrichAnal"]]$results_CPR)
  CoEx.ann.eval_CPR  <- !is.null(dataset.SE@metadata[["CoExpEnrichAnal"]]$results_CPR)
}
