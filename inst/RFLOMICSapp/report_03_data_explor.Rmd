...
```{r check-design, echo=FALSE , message=FALSE, warning=FALSE, echo=FALSE, out.width = "50%",fig.show = "hold",fig.cap=c("*fig.left: number of samples per combination of factor modalities. fig.right: number of features and samples kept after data pre-processing (red dataset)*")}
