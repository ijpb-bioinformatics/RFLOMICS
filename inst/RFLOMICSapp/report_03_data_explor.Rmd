...
write.table(dataset.SE@metadata$rowSums.zero,
             file=paste0(explorDir,"Table_of_non_expressed_",omics.dic[[omictype]][["variableName"]],".txt"),
             sep="\t",quote=FALSE,col.names=TRUE,row.names=TRUE)

write.table(dataset.SE@metadata$FilteredFeatures,
             file=paste0(explorDir,"Table_of_low_expressed_",omics.dic[[omictype]][["variableName"]],".txt"),
             sep="\t",quote=FALSE,col.names=TRUE,row.names=TRUE)
