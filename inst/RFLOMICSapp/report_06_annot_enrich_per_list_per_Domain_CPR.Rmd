...
df <- reactable(dataPlot@result[dataPlot@result$p.adjust < dataPlot@pvalueCutoff, ] %>% dplyr::select(!c("geneID", "qvalue")),
          showSortable = TRUE,
          bordered = TRUE,
...
write.table(dataPlot@result[dataPlot@result$p.adjust < dataPlot@pvalueCutoff, ],
            file=paste0(listnameDir,"Table_of_Enriched_terms_for_",domain,"_","pval<",dataPlot@pvalueCutoff,".txt"),
