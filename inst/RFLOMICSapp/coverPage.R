  ...
  fluidRow(style="display: flex; align-items: center;",
           column(12,
                  ...
                  p(
                    ...
                    across experiments on the same biological indivuals)"),".",
                  ...
                  p("For the moment, Rflomics can deal",
                    ...
                    helps to set up models and contrasts associated to the biological experiments. RNA, proteomic and
                    metabolomic datasets are then analysed with expert methods."),
                  hr(),
                  h3("Aims:"),
                  tags$ul(
                  ...
                  p("",tags$img(src = "Rflomics_features.png", width = "500px", height = "300px"),
                   tags$ul(
