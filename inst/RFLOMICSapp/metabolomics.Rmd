...
* The data were `FlomicsMultiAssay@ExperimentList[[paste0(data,".filtred")]]@metadata$transform_method` transformed.
* The number of metabolite: `r NbProt`  
* Number of metabolite with at least 1 NA: `r NbProt - NbProtWoutNA`

### Distribution of density befor/after transforamtion

```{r densityPlotMeta, echo=FALSE, fig.show = "hold", out.width = "50%", message=FALSE, warning=FALSE}
Data_Distribution_Density.plot(FlomicsMultiAssay@ExperimentList[[paste0(data)]])
