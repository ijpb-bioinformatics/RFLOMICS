...
filt.summary <-  data.frame(c("# Genes (raw)",
                              "# Genes (0 count)",
                              "# Genes (low count)",
                              "# Genes (keep)"),
                            c(length(names(dataset.raw.SE)),
...
* The choosen filtering strategy was `r dataset.SE@metadata$FilteringOptions$Filter_Strategy` with a count per million of read (CPM) cut-off of `r dataset.SE@metadata$FilteringOptions$CPM_Cutoff` 
