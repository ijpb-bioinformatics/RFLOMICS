...
htmltools::HTML(paste0("MixOmics analyses were performed on <span style=\"color:blue\">",  paste(MOres$selectData, collapse = ", "), "</span> datatables with function  <span style=\"color:DarkOrchid\">", funcMixo, "</span> applied on each selected response variable (<span style=\"color:blue\">", paste(MOres$selectedResponse, collapse = ", "), "</span>). Option <span style=\"color:blue\"> scale views </span> was set to",  MOres$scale_views, "."))

if (MOres$sparsity) {
    htmltools::HTML(paste0("Sparse analysis was performed on these data with <span style=\"color:blue\">",  MOres$cases_to_try, "</span> sets of features tested for each datatable."))
}
