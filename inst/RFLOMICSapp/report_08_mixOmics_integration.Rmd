...
```{r mixOmics_load1, fig.height = fig_height*0.75, fig.width = fig_width}
...
```{r mixOmics_load2, fig.height = fig_height*0.75, fig.width = fig_width}
mixOmics::plotLoadings(Data_res, 
                       comp = 2,
                       ndisplay = 10)
```
...
```{r mixOmics_plotInd23, fig.width = fig_width, fig.height = fig_height*0.75}
