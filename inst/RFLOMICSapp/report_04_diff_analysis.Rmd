...
to the `r dataset.SE@metadata[["DiffExpAnal"]]$Adj.pvalue.method` procedure with a cutoff set to `r dataset.SE@metadata[["DiffExpAnal"]]$Adj.pvalue.cutoff`.
LogFC cut-off was set to `r dataset.SE@metadata[["DiffExpAnal"]]$abs.logFC.cutoff`
