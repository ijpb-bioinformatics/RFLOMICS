...
out <- NULL
  ...
  for (contrast  in  dataset.SE@metadata[["DiffExpAnal"]][["contrasts"]]$contrastName) {
    # if( dim(dataset.SE@metadata[["DiffExpAnal"]][["TopDEF"]][[contrast]])[1] != 0 ){
