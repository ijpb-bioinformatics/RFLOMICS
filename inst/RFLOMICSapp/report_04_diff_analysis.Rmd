...
Differential expression analysis was carried out for each selected contrast thanks to the `r getDiffSetting(dataset.SE)$method` model.
...
to the `r getDiffSetting(dataset.SE)$Adj.pvalue.method` procedure with a cutoff set to `r getDiffSetting(dataset.SE)$Adj.pvalue.cutoff`.
LogFC cut-off was set to `r getDiffSetting(dataset.SE)$abs.logFC.cutoff`
