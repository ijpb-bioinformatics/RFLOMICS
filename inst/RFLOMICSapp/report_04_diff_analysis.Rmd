...
```{r Upset_plot, fig.show = "hold", out.width = "80%", fig.cap=paste0("<p style=\"color:grey\">","*fig: This **UpSetR** plot gives the number of common and specific differential expressed ",variableName," per contrasts.*", "</p>")}
