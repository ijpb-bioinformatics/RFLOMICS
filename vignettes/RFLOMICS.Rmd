...
![MixOmics Settings](Images/MixOmics_settings.png){width=50%}
...
* Explained variance: for each component, display the origin of the explained variance and the cumulative explained variance for each table. 
* Individuals: from the mixOmics::plotIndiv() function, display for each table the coordinates of the individuals.
* Features: from the mixOmics::plotVar() function, display for each table the coordinates of the features on the correalation circle.
