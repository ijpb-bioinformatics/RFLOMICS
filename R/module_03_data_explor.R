    ...
    function(input,
        ...
        observeEvent(input$run, {
            ...
            rea.values$datasetProcess <-
                rea.values$datasetProcess[rea.values$datasetProcess != dataset]
            ...
            session$userData$FlomicsMultiAssay <-
                resetFlomicsMultiAssay(session$userData$FlomicsMultiAssay,
            ...
            rea.values$datasetProcess <-
                unique(c(rea.values$datasetProcess , dataset))
